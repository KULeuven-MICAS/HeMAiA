...
% if occamy_cfg['hemaia_multichip']['single_chip'] is False: 
  // Currently the router is implemented, so bidirectional connections toward E/S/W/N is needed, with 578b payload
    ...
    output logic     [3-1:0] link_to_east_valid_o,
    ...
    output logic     [3-1:0] link_to_west_valid_o,
    ...
    output logic     [3-1:0] link_to_north_valid_o,
    ...
    output logic     [3-1:0] link_to_south_valid_o,
...
% if occamy_cfg['hemaia_multichip']['single_chip'] is False:
  ...
  hemaia_d2d_link #(
    ...
    .link_to_east_valid_o(link_to_east_valid_o),
    .flow_control_east_rts_o(flow_control_east_rts_o),
    .flow_control_east_cts_i(flow_control_east_cts_i),
    ...
    .link_to_west_valid_o(link_to_west_valid_o),
    .flow_control_west_rts_o(flow_control_west_rts_o),
    .flow_control_west_cts_i(flow_control_west_cts_i),
    ...
    .link_to_north_valid_o(link_to_north_valid_o),
    .flow_control_north_rts_o(flow_control_north_rts_o),
    .flow_control_north_cts_i(flow_control_north_cts_i),
    ...
    .link_to_south_valid_o(link_to_south_valid_o),
    .flow_control_south_rts_o(flow_control_south_rts_o),
    .flow_control_south_cts_i(flow_control_south_cts_i),
    .flow_control_south_rts_i(flow_control_south_rts_i),
    .flow_control_south_cts_o(flow_control_south_cts_o)
  );
