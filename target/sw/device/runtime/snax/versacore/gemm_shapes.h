...
//
// Fallback shape table for snax_versacore_to_256KB_cluster (also its SIMD
// variant). Normal builds put runtime/generated first on the include path and
// use the table generated by gemm_shapes.mk for the selected hardware. The
// generic 512KB configuration has a different shape 0 and uses that generated
// table. validate_shapes.py can check this fallback against the 256KB config.
//
...
//
// Hardware changes are reflected automatically in the generated table. Keep
// this fallback aligned with the 256KB default using the derivation above.
...
// (snax_versacore_to_256KB_cluster.hjson). Checked by validate_shapes.py.
// ----------------------------------------------------------------------
...
// hwcfg snax_acc_cfg `granularity_a`. The A
