...
typedef struct {
    ...
    bingo_sw_offload_unit_t bingo_sw_offload_unit; // shared pointer to the bingo offload sw unit
    bingo_hw_offload_unit_t bingo_hw_offload_unit; // shared pointer to the bingo offload hw unit
