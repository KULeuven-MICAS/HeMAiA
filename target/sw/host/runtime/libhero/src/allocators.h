...
// L2_Mailbox: Mailbox starting from the beginning of L2
// L3: Wide SoC Shared Memory
// The L2_Mailbox will be mainly on the mailbox and control
// The rest of the L2 will be on the heap
...
extern struct O1HeapInstance *l2_mailbox_manager;
extern uint64_t l2_mailbox_start_phy, l2_mailbox_start_virt, l2_mailbox_size;
