...
A block is imported for its class (Attention, MoeFFN) or, where the work is not a block,
...
from .attention import Attention, FaCfg
from .gather import fa_gather
from .moe import MoeCfg, MoeFFN

__all__ = ["Attention", "FaCfg", "fa_gather", "MoeCfg", "MoeFFN"]
