...
uint32_t __workload_versacore_intra_chiplet(bingo_task_t** task_list) {
    ...
    uintptr_t cluster_l1_addr_A = bingo_l1_alloc(
        current_chip_id, 0, BINGO_CHIPLET_READW(AdataTileSize));
    ...
    uintptr_t cluster_l1_addr_B = bingo_l1_alloc(
        current_chip_id, 0, BINGO_CHIPLET_READW(BdataSize));
    ...
    uintptr_t cluster_l1_addr_C = bingo_l1_alloc(
        current_chip_id, 0, BINGO_CHIPLET_READW(CdataSize));
    uintptr_t cluster_l1_addr_D = bingo_l1_alloc(
        current_chip_id, 0, BINGO_CHIPLET_READW(DdataSize));
