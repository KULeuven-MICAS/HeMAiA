...
def emit_header_file(**kwargs):
    ...
    lines = [
        ...
        "// Chip00 receive slots for A2, A3, A4 copied back from chiplets 01, 10, 11.",
        format_vector_declaration(
            "uint8_t",
            "A_recv_chip00_l3",
...
def main():
    parser = argparse.ArgumentParser(description="Generating data for DMA cross-chiplet test")
