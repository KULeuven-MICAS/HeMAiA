...
"""
Cross-chiplet system-iDMA sub-test for four chiplets with two active clusters each.
...
Flow:
  ...
  4. Chip00 uses system iDMA to pull the per-cluster L3 staging chunks from
     chiplets 01, 10, and 11 into chip00 L3.
...
WORKLOAD_NAME = "idma_read_from_chip00_4chiplet_2cluster"
...
def main():
    ...
    for chiplet_pos, chiplet in enumerate(EXPECTED_CHIPLETS[1:], start=1):
        ...
        for cluster_id in CLUSTER_IDS:
            ...
            copy_to_chip00 = BingoNode(
                ...
                assigned_cluster_id=0,
                assigned_core_id=HOST_CORE,
                node_name=f"IdmaPull_{a_name}_Chip{h}_C{cluster_id}_L3_to_Chip00",
    ...
    print("Built DFG: load/store/check A1..A8, then system-iDMA pull/check A3..A8 on chip00")
