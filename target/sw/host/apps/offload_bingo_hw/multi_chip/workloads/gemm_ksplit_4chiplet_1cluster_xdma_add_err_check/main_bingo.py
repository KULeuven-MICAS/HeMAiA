...
# Four-chiplet K-split GEMM with xDMA elementwise-add reduction on chiplet 00 and
# intermediate running-sum checks after each add. The current source uses one
# cluster per chiplet and `k_split=4`.
#
...
#
# Chip00 xDMA reduction and checks:
#   Check_D_partial_k0 + Check_D_partial_k1 -> Copy_D_k1_to_Chip00_L1
#   Check_D_partial_k0 + Copy_D_k1_to_Chip00_L1 -> XDMA_Add_k0_to_k1
#   XDMA_Add_k0_to_k1 -> Load_Golden_sum_k0_to_k1 -> Check_sum_k0_to_k1
#   Check_sum_k0_to_k1 + Check_D_partial_k2 -> Copy_D_k2_to_Chip00_L1
#   Check_sum_k0_to_k1 + Copy_D_k2_to_Chip00_L1 -> XDMA_Add_k0_to_k2
#   XDMA_Add_k0_to_k2 -> Load_Golden_sum_k0_to_k2 -> Check_sum_k0_to_k2
#   Check_sum_k0_to_k2 + Check_D_partial_k3 -> Copy_D_k3_to_Chip00_L1
#   Check_sum_k0_to_k2 + Copy_D_k3_to_Chip00_L1 -> XDMA_Add_k0_to_k3
#   XDMA_Add_k0_to_k3 -> Load_Golden_sum_k0_to_k3 -> Check_sum_k0_to_k3
