...
Tests the FP32->INT8 quantize host kernel (HostBingoKernelAraQuantizeF32I8Args) by quantizing a FP32 input
...
def get_args():
    parser = argparse.ArgumentParser(description="basic_quantize_host")
...
def main():
    ...
    node_quantize = BingoNode(
        ...
        kernel_args=HostBingoKernelAraQuantizeF32I8Args(
    ...
    dfg.bingo_compile_dfg(
        "basic_quantize_host", output_dir, args.output_offload_file_name,
