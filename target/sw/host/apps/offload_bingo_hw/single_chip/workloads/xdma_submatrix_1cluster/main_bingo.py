...
# Per-op xDMA submatrix extraction sweep over nine configurations.
#
# Task dependency graph:
#
# For each config i = 0..8:
#   Load_i -> Op_i -> Store_submatrix_cfg[i] -> Check_submatrix_cfg[i]
#
# Config ordering:
#   Check_submatrix_cfg[i] -> Load_[i+1]    for i = 0..7
