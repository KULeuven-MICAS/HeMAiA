...
#
# Per-op xDMA workload: functional check + cycle sweep for the "gather" op.
# Each CONFIGS entry runs Load -> xDMA gather -> Store -> Check and emits one
...
# Per-op xDMA gather sweep over nine configurations.
#
# Task dependency graph:
#
# For each config i = 0..8:
#   Load_i -> Op_i -> Store_gather_cfg[i] -> Check_gather_cfg[i]
#
# Config ordering:
#   Check_gather_cfg[i] -> Load_[i+1]    for i = 0..7
