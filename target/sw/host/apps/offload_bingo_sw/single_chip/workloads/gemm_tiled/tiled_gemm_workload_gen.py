...
''']
    ...
    emit_str += emit_kernel_execution()
    return "\n".join(emit_str)

def emit_kernel_execution():
    emit_str = ['''
// Kernel Execution
...
uint32_t __workload_gemm_tiled(bingo_task_t **task_list)
{
    ///////////////////
    // Main function //
    ///////////////////
...
def main():
    ...
    # Emit header file
    with open("offload_bingo_sw.h", "w", encoding="utf-8") as f:
        f.write(emit_workload_file(**merged_config))
