...
// kernel "rmsnorm" (bingo dispatches it to CVA6+Ara).  Per size it prints:
//   CYCLES,rmsnorm,<N>,<rep>,<cycles>   (timing)
//   CHECK,rmsnorm,<N>,PASS|FAIL         (output vs golden from util/sim/ara_lib.py)
