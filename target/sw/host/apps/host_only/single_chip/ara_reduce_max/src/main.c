...
// kernel "reduce_max" (bingo dispatches it to CVA6+Ara).  Per size it prints:
//   CYCLES,reduce_max,<N>,<rep>,<cycles>   (timing)
//   CHECK,reduce_max,<N>,PASS|FAIL         (output vs golden from util/sim/ara_lib.py)
