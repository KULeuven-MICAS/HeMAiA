...
// kernel "reduce_sum" (bingo dispatches it to CVA6+Ara).  Per size it prints:
//   CYCLES,reduce_sum,<N>,<rep>,<cycles>   (timing)
//   CHECK,reduce_sum,<N>,PASS|FAIL         (output vs golden from util/sim/ara_lib.py)
