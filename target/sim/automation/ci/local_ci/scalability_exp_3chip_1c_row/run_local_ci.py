#!/usr/bin/env python3
"""
HeMAiA CI runner -- ``hemaia_scalability_exp_3chip_1c_row`` suite
================================================

Builds and runs the ``task_local_ci.yaml`` next to this script through the shared
:class:`HeMAiASimRunner`, against ``target/rtl/cfg/hemaia_scalability_exp_3chip_1c_row.hjson``:
3 chiplets in a row at x = 0..2, 1x ``snax_versacore_to_cluster`` each,
mem chip at [3,0].
...
CI_CFG = "target/rtl/cfg/hemaia_scalability_exp_3chip_1c_row.hjson"
