#!/usr/bin/env python3
"""
HeMAiA CI runner -- ``hemaia_scalability_exp_4chip_4c`` suite
===================================================

Builds and runs the ``task_local_ci.yaml`` next to this script through the shared
:class:`HeMAiASimRunner`, against ``target/rtl/cfg/hemaia_scalability_exp_4chip_4c.hjson``:
4 chiplets (2x2), 4x ``snax_versacore_to_cluster`` per chiplet = 16 workers.
...
CI_CFG = "target/rtl/cfg/hemaia_scalability_exp_4chip_4c.hjson"
