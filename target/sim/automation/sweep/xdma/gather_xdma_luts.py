...
# The fused SIMD kernels (softmax / rmsnorm / rope / silu / swiglu) were gathered here
# while the operator chain hung off the xDMA's reader-extension socket. On
# snax_split_cluster the SIMD block is its own hart emitting BINGO_TRACE_SIMD_* rather
# than BINGO_TRACE_XDMA_*, so their gathering moved to
# target/sim/automation/sweep/simd/gather_simd_luts.py.
