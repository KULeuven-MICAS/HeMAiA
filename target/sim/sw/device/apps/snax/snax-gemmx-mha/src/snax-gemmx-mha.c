    ...
    if (snrt_cluster_idx() == 1) {  // Set err value for checking
        ...
        if (snrt_cluster_core_idx() == 0) {
            ...
            set_gemmx_streamer_csr(
                Aslstride0_1, Aslstride1_1, Atlbound0_1, Atlstride0_1, Atlbound1_1,
                Atlstride1_1, Atlbound2_1, Atlstride2_1, Atlbound3_1, Atlstride3_1,
                Atlbound4_1, Atlstride4_1, Atlbound5_1, Atlstride5_1,
                set_addr_remap_index_A,

                Bslstride0_1, Bslstride1_1, Btlbound0_1, Btlstride0_1, Btlbound1_1,
                Btlstride1_1, Btlbound2_1, Btlstride2_1, set_addr_remap_index_B,

                D8slstride0_1, D8slstride1_1, D8tlbound0_1, D8tlstride0_1, D8tlbound1_1,
                D8tlstride1_1, D8tlbound2_1, D8tlstride2_1, set_addr_remap_index_D8,

                Cslstride0_1, Cslstride1_1, Ctlbound0_1, Ctlstride0_1, Ctlbound1_1,
                Ctlstride1_1, Ctlbound2_1, Ctlstride2_1, set_addr_remap_index_C,
                ...
                delta_local_a_X, delta_local_b_Wq, delta_local_d8_Q, delta_local_d32,
                // no transpose
        ...
        if (snrt_cluster_core_idx() == 0) {
            ...
            set_gemmx_streamer_csr(
                ...
                delta_local_a_X, delta_local_b_Wk, delta_local_d8_K, delta_local_d32,
                // no transpose
                delta_local_d32, bypassSIMD, transposed_A_1, transposed_B_1,
                channel_en_C, broadcast_C);
        ...
        if (snrt_cluster_core_idx() == 0) {
            // Set Streamer configuration CSR for conv2d
            set_gemmx_streamer_csr(
                Aslstride0_2, Aslstride1_2, Atlbound0_2, Atlstride0_2, Atlbound1_2,
                Atlstride1_2, Atlbound2_2, Atlstride2_2, Atlbound3_2, Atlstride3_2,
                Atlbound4_2, Atlstride4_2, Atlbound5_2, Atlstride5_2,
                set_addr_remap_index_A,

                Bslstride0_2, Bslstride1_2, Btlbound0_2, Btlstride0_2, Btlbound1_2,
                Btlstride1_2, Btlbound2_2, Btlstride2_2, set_addr_remap_index_B,

                D8slstride0_2, D8slstride1_2, D8tlbound0_2, D8tlstride0_2, D8tlbound1_2,
                D8tlstride1_2, D8tlbound2_2, D8tlstride2_2, set_addr_remap_index_D8,

                Cslstride0_2, Cslstride1_2, Ctlbound0_2, Ctlstride0_2, Ctlbound1_2,
                Ctlstride1_2, Ctlbound2_2, Ctlstride2_2, set_addr_remap_index_C,

                D32slstride0, D32slstride1, D32tlbound0, D32tlstride0,
                D32tlbound1, D32tlstride1, D32tlbound2, D32tlstride2,
                set_addr_remap_index_D32,

                delta_local_d8_Q, delta_local_d8_K, delta_local_d8_S, delta_local_d32,
                // transpose K
        ...
        if (snrt_cluster_core_idx() == 0) {
            ...
            set_gemmx_streamer_csr(
                ...
                delta_local_a_X, delta_local_b_Wv, delta_local_d8_V, delta_local_d32,
                // no transpose
                delta_local_d32, bypassSIMD, transposed_A_1, transposed_B_1,
                channel_en_C, broadcast_C);
        ...
        if (snrt_cluster_core_idx() == 0) {
            ...
            set_gemmx_streamer_csr(
                ...
                delta_local_d8_S, delta_local_d8_V, delta_local_d8_Z, delta_local_d32,
                // no transpose
                delta_local_d32, bypassSIMD, transposed_A_1, transposed_B_1,
                channel_en_C, broadcast_C);
