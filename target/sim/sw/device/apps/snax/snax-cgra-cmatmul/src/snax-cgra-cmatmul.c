...
int main() {
    if (snrt_cluster_idx() == 0) {
        ...
        // Using DMA only
        if (snrt_is_dm_core()) {
           if (debug_mode) {printf("[CGRAX] CGRA-DMA START \r\n");}
