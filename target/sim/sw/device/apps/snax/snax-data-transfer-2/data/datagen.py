...
def main():
    ...
    half_super_bank = 65536

    # Generating sample query hypervector
    data_set = np.frombuffer(np.random.bytes(num_bytes), dtype=np.uint32)
    ...
    num_half_super_bank_str = format_scalar_definition("uint32_t", "half_super_bank", half_super_bank)
