...
# Only the macro
make -C "$script_dir/../.." hemaia_system_vsim_preparation SIM_CFG="$sim_cfg_dir/sim_mem_macro.hjson"
...
# Macro + netlist
make -C "$script_dir/../.." hemaia_system_vsim_preparation SIM_CFG="$sim_cfg_dir/sim_netlist.hjson"
