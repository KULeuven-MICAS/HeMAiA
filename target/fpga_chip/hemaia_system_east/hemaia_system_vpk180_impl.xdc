...
#  Channel 2 -> cable 2
#  Channel 3 -> cable 1
set_property -dict "PACKAGE_PIN CD51 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[0]"]
set_property -dict "PACKAGE_PIN CD52 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[1]"]
set_property -dict "PACKAGE_PIN BU41 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[2]"]
set_property -dict "PACKAGE_PIN BR42 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[3]"]
set_property -dict "PACKAGE_PIN BU42 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[4]"]
set_property -dict "PACKAGE_PIN BT41 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[5]"]
set_property -dict "PACKAGE_PIN BN40 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[6]"]
set_property -dict "PACKAGE_PIN BW39 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[7]"]
set_property -dict "PACKAGE_PIN BP40 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[8]"]
set_property -dict "PACKAGE_PIN BY39 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[9]"]
set_property -dict "PACKAGE_PIN CB40 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[10]"]
set_property -dict "PACKAGE_PIN CD42 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[11]"]
set_property -dict "PACKAGE_PIN CC40 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[12]"]
set_property -dict "PACKAGE_PIN CD43 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[13]"]
set_property -dict "PACKAGE_PIN CD40 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[14]"]
set_property -dict "PACKAGE_PIN CD41 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[15]"]
set_property -dict "PACKAGE_PIN CB41 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[16]"]
set_property -dict "PACKAGE_PIN CA38 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[17]"]
set_property -dict "PACKAGE_PIN CC42 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[18]"]
set_property -dict "PACKAGE_PIN CC38 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[19]"]
set_property -dict "PACKAGE_PIN CB39 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[20]"]
set_property -dict "PACKAGE_PIN BT37 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[21]"]
set_property -dict "PACKAGE_PIN BY40 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[22]"]
set_property -dict "PACKAGE_PIN CC39 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[23]"]
set_property -dict "PACKAGE_PIN BU37 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[24]"]
set_property -dict "PACKAGE_PIN CA39 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[25]"]
set_property -dict "PACKAGE_PIN BY38 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[26]"]
set_property -dict "PACKAGE_PIN BR37 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[27]"]
set_property -dict "PACKAGE_PIN CA37 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[28]"]
set_property -dict "PACKAGE_PIN BR38 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[29]"]
set_property -dict "PACKAGE_PIN BR41 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[30]"]
set_property -dict "PACKAGE_PIN BR39 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[31]"]
set_property -dict "PACKAGE_PIN BT40 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[32]"]
set_property -dict "PACKAGE_PIN BT39 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[33]"]
set_property -dict "PACKAGE_PIN BV41 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[34]"]
set_property -dict "PACKAGE_PIN BY41 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[35]"]
set_property -dict "PACKAGE_PIN BW41 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[36]"]
set_property -dict "PACKAGE_PIN CA41 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[37]"]
set_property -dict "PACKAGE_PIN BY43 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[38]"]
set_property -dict "PACKAGE_PIN BY44 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[39]"]
set_property -dict "PACKAGE_PIN BV49 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[40]"]
set_property -dict "PACKAGE_PIN CB46 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[41]"]
set_property -dict "PACKAGE_PIN BV50 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[42]"]
set_property -dict "PACKAGE_PIN CC47 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[43]"]
set_property -dict "PACKAGE_PIN BW51 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[44]"]
set_property -dict "PACKAGE_PIN BW52 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[45]"]
set_property -dict "PACKAGE_PIN CD47 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[46]"]
set_property -dict "PACKAGE_PIN CA44 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[47]"]
set_property -dict "PACKAGE_PIN CA49 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[48]"]
set_property -dict "PACKAGE_PIN CD48 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[49]"]
set_property -dict "PACKAGE_PIN CC43 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[50]"]
set_property -dict "PACKAGE_PIN CB45 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[51]"]
set_property -dict "PACKAGE_PIN CB50 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[52]"]
set_property -dict "PACKAGE_PIN CB44 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[53]"]
set_property -dict "PACKAGE_PIN BY49 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[54]"]
set_property -dict "PACKAGE_PIN BY50 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[55]"]
set_property -dict "PACKAGE_PIN CB49 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[56]"]
set_property -dict "PACKAGE_PIN CC45 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[57]"]
set_property -dict "PACKAGE_PIN CC44 IOSTANDARD $iostd SLEW FAST" [get_ports "$d2d_io_port[58]"]
...
set_false_path -from [get_pins hemaia_system_i/axis_vio_0/probe_out4[0]]
