...
########## D2D #############
set rx_clk_1_io_port {west_d2d_io_0[0]}
set rx_clk_2_io_port {west_d2d_io_0[20]}
...
set_false_path -through [get_nets -quiet {hemaia_system_i/occamy_chip/inst/i_d2d_link/i_controller_reg_to_hw/reg2hw[rx_buffer_threshold_register][west_rx_buffer_threshold][q][*]}]
set_false_path -through [get_nets -quiet {hemaia_system_i/occamy_chip/inst/i_d2d_link/i_controller_reg_to_hw/u_tx_backoff_period_register_west_tx_backoff_period/reg2hw[tx_backoff_period_register][west_tx_backoff_period][q][*]}]
set_false_path -through [get_nets -quiet {hemaia_system_i/occamy_chip/inst/i_d2d_link/reg2hw[tx_hold_period_register][west_tx_hold_period][q][*]}]
