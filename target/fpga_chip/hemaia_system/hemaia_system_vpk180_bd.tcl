...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.PS_PMC_CONFIG { \
      ...
      PMC_MIO0 {{AUX_IO 0} {DIRECTION out} {DRIVE_STRENGTH 8mA} {OUTPUT_DATA default} {PULL pullup} {SCHMITT 0} {SLEW slow} {USAGE Reserved}} \
      ...
      PMC_SD0 {{CD_ENABLE 1} {CD_IO {PMC_MIO 24}} {POW_ENABLE 1} {POW_IO {PMC_MIO 17}} {RESET_ENABLE 0} {RESET_IO {PMC_MIO 17}} {WP_ENABLE 1} {WP_IO {PMC_MIO 25}}} \
