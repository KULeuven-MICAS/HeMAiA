...
if { $EXT_JTAG } {
    ...
    set_property used_in_synthesis false [get_files hemaia_system_east/hemaia_system_east.srcs/constrs_1/imports/hemaia_system_east/hemaia_system_vpk180_impl_ext_jtag.xdc]
} else {
