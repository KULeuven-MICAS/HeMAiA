...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.MMCM_CLKOUT1_DIVIDE {105} \
    CONFIG.MMCM_CLKOUT2_DIVIDE {82} \
    CONFIG.MMCM_CLKOUT2_PHASE {59.817} \
